...
insert  into `nota_simpanan`(`id_nota`,`nia`,`tanggal`,`username`) values (1,11161,'2013-01-28 21:01:18','yudha'),(2,11162,'2013-01-28 22:25:52','yudha'),(4,11166,'2013-01-29 01:23:06','yudha'),(5,11166,'2013-01-29 01:28:59','yudha'),(6,11166,'2013-01-29 01:29:45','yudha'),(7,11166,'2013-01-29 01:30:08','yudha'),(8,11166,'2013-01-29 01:31:15','yudha'),(9,11166,'2013-01-29 01:31:49','yudha'),(10,11166,'2013-01-29 01:32:24','yudha'),(11,11166,'2013-01-29 01:32:45','yudha'),(12,11166,'2013-01-29 01:33:06','yudha'),(13,11166,'2013-01-29 01:33:13','yudha'),(14,11166,'2013-01-29 01:33:37','yudha'),(15,11166,'2013-01-29 02:00:42','yudha'),(16,11166,'2013-01-29 02:01:30','yudha'),(17,11166,'2013-01-29 02:02:28','yudha'),(18,11166,'2013-01-29 02:02:46','yudha'),(19,11166,'2013-01-29 02:02:59','yudha'),(20,11166,'2013-01-29 02:04:09','yudha'),(21,11166,'2013-01-29 02:05:25','yudha');
...
CREATE TABLE `simpanan` (
  ...
  CONSTRAINT `nota_simpanan` FOREIGN KEY (`id_nota`) REFERENCES `nota_simpanan` (`id_nota`) ON DELETE CASCADE ON UPDATE CASCADE,
...
insert  into `simpanan`(`id_simpanan`,`id_nota`,`id_jenis_simpanan`,`bulan`,`tahun`) values (1,1,2,'01','2013'),(3,2,1,NULL,'2013'),(5,NULL,1,NULL,'2013'),(6,NULL,1,NULL,'2013'),(7,NULL,1,NULL,'2013'),(8,14,1,NULL,'2013'),(9,NULL,2,'01','2013'),(10,NULL,2,'02','2013'),(11,NULL,2,'01','2013'),(12,10,2,'01','2013'),(13,10,2,'02','2013'),(14,NULL,2,'03','2013'),(15,NULL,2,'04','2013'),(16,NULL,2,'03','2013'),(17,NULL,2,'04','2013'),(18,20,2,'03','2013'),(19,20,2,'04','2013'),(20,20,2,'05','2013');
