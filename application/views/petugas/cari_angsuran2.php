<div class="span10">
    ...
    <?php
    echo form_open('petugas/pinjaman_tambah', 'tambah Pinjaman', 'class="well"');
    ?>
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <td><center>
                <a href="<?php echo site_url() ?>/petugas/form_angsuran/<?php echo $agt->id_pinjaman ?>">Tambah Angsuran</a>
            </center></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
