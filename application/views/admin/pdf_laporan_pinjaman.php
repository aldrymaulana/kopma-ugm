...
*/
$this->fpdf->Cell(19,0.7,'LAPORAN PINJAMAN',0,0,'C');
...
$this->fpdf->Cell(19,1,'LAPORAN DATA PINJAMAN',0,0,'C');
 
 
/* setting header table */
$this->fpdf->Ln(1);
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Cell(2  , 1, 'ID '           , 1, 'LR', 'C');
$this->fpdf->Cell(2 , 1, 'Nia' , 1, 'LR', 'C');
$this->fpdf->Cell(5 , 1, 'Nama' , 1, 'LR', 'C');
$this->fpdf->Cell(3 , 1, 'Pinjaman' , 1, 'LR', 'C');
$this->fpdf->Cell(3 , 1, 'Sisa' , 1, 'LR', 'C');
...
foreach($pinjaman as $hasil)
{
    ...
    $this->fpdf->Cell(2  , 0.7, $hasil->id_pinjaman  , 1, 'LR', 'C');
    $this->fpdf->Cell(2 , 0.7, $hasil->nia , 1, 'LR', 'C');
    $this->fpdf->Cell(5 , 0.7, $hasil->nama , 1, 'LR', 'C');
    $this->fpdf->Cell(3 , 0.7, $hasil->value , 1, 'LR', 'C');
    $this->fpdf->Cell(3 , 0.7, $hasil->sisa , 1, 'LR', 'C');
    $this->fpdf->Cell(4 , 0.7, $hasil->tanggal , 1, 'LR', 'C');
}
