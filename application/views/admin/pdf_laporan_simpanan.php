...
*/
$this->fpdf->Cell(19,0.7,'LAPORAN Simpanan',0,0,'C');
...
$this->fpdf->Cell(19,1,'LAPORAN DATA SIMPANAN',0,0,'C');
...
$this->fpdf->Cell(3 , 1, 'Jenis' , 1, 'LR', 'C');
$this->fpdf->Cell(2 , 1, 'Bulan' , 1, 'LR', 'C');
$this->fpdf->Cell(2 , 1, 'Tahun' , 1, 'LR', 'C');
$this->fpdf->Cell(4 , 1, 'Tanggal' , 1, 'LR', 'C');
...
foreach($smpn as $smp)
{
    ...
    $this->fpdf->Cell(1  , 0.7, $smp->id_simpanan  , 1, 'LR', 'C');
    $this->fpdf->Cell(2 , 0.7, $smp->nia , 1, 'LR', 'C');
    $this->fpdf->Cell(5 , 0.7, $smp->nama , 1, 'LR', 'C');
    $this->fpdf->Cell(3 , 0.7, $smp->jenis_simpanan , 1, 'LR', 'C');
    $this->fpdf->Cell(2 , 0.7, $smp->bulan , 1, 'LR', 'C');
    $this->fpdf->Cell(2 , 0.7, $smp->tahun , 1, 'LR', 'C');
    $this->fpdf->Cell(4 , 0.7, $smp->tanggal , 1, 'LR', 'C');
}
