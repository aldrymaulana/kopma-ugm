    ...
    if (empty($hasil)) {
        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
                ...
                <td><center>
                    <a href="<?php echo site_url() . '/admin/form_simpanan_pokok/1/' . date('Y') . '/' . $agt->nia ?>">Simpanan pokok</a>
                    <?php
                    echo ' | ';
                    ?>
                    <a href="<?php echo site_url() . '/admin/form_simpanan_wajib/2/' . date('Y') . '/' . $agt->nia ?>">Simpanan Wajib</a>
                </center></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
