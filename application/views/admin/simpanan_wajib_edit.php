            ...
            <div class="row-fluid">
                ...
                <?php echo form_open('admin/simpanan_wajib_tambah', 'class="well"') ?>
                      <div class="group-option">
                        <label>Nia</label>
                        <input class="input-xlarge"  value="<?php echo $data->nia ?>" name="nia" readonly>
                    </div>
                    <div class="group-option">
                        <label>Nama</label>
                        <input class="input-xlarge"  value="<?php echo $data->nama ?>" name="nama" readonly>
                    </div>
                    <div class="group-option">
                        <label>Jenis Simpanan</label>
                        <input class="input-xlarge"  value="<?php echo $this->uri->segment(3) ?>" name="simpanan" hidden>
                    ...
                    <div class="group-option">
                        <button class="btn btn-primary"><i class="icon-plus icon-white"></i> Perbaharui</button>
                    </div>
                <?php echo form_close(); ?>
            </div>
        </div>
